...
function renderVitals(data) {
    ...
    var directives = {
        ...
        Distro: {
            html: function () {
                return '<table class="borderless table-hover" style="width:100%;"><tr><td class="nopadding" style="width:32px;"><img src="gfx/images/' + this.Distroicon + '" alt="" style="width:32px;height:32px;" /></td><td class="paddingleft" style="vertical-align:middle;">' + this.Distro + '</td></tr></table>';
            }
        },
        LoadAvg: {
            html: function () {
                if (this.CPULoad !== undefined) {
                    return '<table class="borderless table-hover" style="width:100%;"><tr><td class="nopadding" style="width:50%;">'+this.LoadAvg + '</td><td class="paddingleft"><div class="progress">' +
