...
function dmraid_buildinfos(xml, id) {
    ...
    button += "<h3 style=\"cursor:pointer\" id=\"sPlugin_DMRaid_Info" + id + "\"><img src=\"./gfx/bullet_toggle_plus.gif\" alt=\"plus\" style=\"vertical-align:middle;width:16px;\" />" + genlang(3, false, "DMRaid") + "</h3>";
    button += "<h3 style=\"cursor:pointer; display:none;\" id=\"hPlugin_DMRaid_Info" + id + "\"><img src=\"./gfx/bullet_toggle_minus.gif\" alt=\"minus\" style=\"vertical-align:middle;width:16px;\" />" + genlang(3, false, "DMRaid") + "</h3>";
