...
//            alert("--" + diskstatus + "--");
        ...
        if (!isNaN(parentid)) {
            if (type === "disk") {
                ...
                if (parentid === 0) {
                    $("#Plugin_Raid_List-" + id).append("<div id=\"Plugin_Raid_Item" + id + "-" + (itemid+1) + "\" style=\"border:solid;border-width:2px;border-radius:5px;border-color:" + bcolor + ";margin:10px;display:-moz-inline-box;display:inline-block;text-align:center\">" + name + "<br></div>");
                } else {
                    $("#Plugin_Raid_Item" + id + "-" + parentid).append("<div id=\"Plugin_Raid_Item" + id + "-" + (itemid+1) + "\" style=\"border:solid;border-width:2px;border-radius:5px;border-color:" + bcolor + ";margin:10px;display:-moz-inline-box;display:inline-block;text-align:center\">" + name + "<br></div>");
                } 
            }
        }
    });
