        ...
        if (raiditems.length > 0) {
            ...
            for (var i = 0; i < raiditems.length ; i++) {
                ...
                if (raiditems[i].RaidItems !== undefined) {
                    ...
                    if (!isNaN(parseInt(raiditems[i]["@attributes"].Size))) html += "<tr class=\"treegrid-parent-raid-" + i + "\"><td><span class=\"treegrid-spanbold\">"+genlang(7, true, 'raid')+"</span></td><td>" + parseInt(raiditems[i]["@attributes"].Size) + "</td></tr>";// Size
